var util = {
  ...
  getStaticRegExpPhoneList: function() {
    return [{
      supplier: "联通",
      patterns: [/^(13[0-2]|145|15[5-6])\d{8}$/, /^17[156]\d{8}$/, /^170[7-9]\d{7}$/, /^18[5-6]\d{8}$/]
    }, {
      supplier: "电信",
      patterns: [/^(133|153)\d{8}$/, /^(18[0-1]|189)\d{8}$/, /^17[37]\d{8}$/, /^170[0-2]\d{7}$/]
    }, {
      supplier: "移动",
      patterns: [/^(13[4-9]|147|15[0-2]|15[7-9])\d{8}$/, /^170[3-6]\d{7}$/, /^178\d{8}$/, /^(18[2-4]|18[7-8])\d{8}$/, /^147\d{8}$/]
    }];
  }
};
module.exports = util;